...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 4:
        print("Usage: python clap_inferencer.py <MODELS_PATH> <wav_a> <wav_b>  # prints FD between two wavs")
        sys.exit(1)
    inferencer = ClapInferencer(sys.argv[1])
    fd = inferencer.infer_fd(sys.argv[2], sys.argv[3])
    print(fd)
